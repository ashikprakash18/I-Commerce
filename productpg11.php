...
<body>
  <div class="navbar">
    ...
    <section class="section-a">
      <div class="container">
        <div>
          <h1 style="font-family: 'Work Sans', sans-serif;">The headphones of the future.</h1>
          <p style="font-family: 'Work Sans', sans-serif;">Good quality headphones   <br> <br>  
	<span style="color: orange;" class="fa fa-star checked"></span>
        <span style="color: orange;"class="fa fa-star checked"></span>
        <span style="color: orange;" class="fa fa-star checked"></span><!-- -->
        <span style="color: orange;" class="fas fa-star-half-alt"></span>
        <span style="color: orange;" class="far fa-star"></span><br> <br>
        <span class="current" style="font-family: 'Work Sans', sans-serif;">₹ 1444.99</span>    
            <br><br>
...
<!-- -->
    ...
    <button style="border-radius: 30px; font-size: 15px;" type="button" class="fas fa-times btn cancel" onclick="closeForm()">  Close</button>
        ...
        <img style="padding-left: 150px;width: 100%; " src="https://assets.myntassets.com/f_webp,h_560,q_90,w_420/v1/assets/images/12333774/2020/8/24/226e9b32-1bfa-439f-b4bf-470330a909851598249685015-Infinity-JBL-Tranz-700-Wireless-Headphones-with-20-Hours-Pla-1.jpg" alt="" />
      </div>

...
<body>
  <div class="navbar">
    ...
    <section class="section-a">
      <div class="container">
        <div>
          <h1 style="font-family: 'Work Sans', sans-serif;">Fenzy Styles Active Wear Sports Wear</h1>
          <p style="font-family: 'Work Sans', sans-serif;">Ships from and sold by Krishna Sports, Malad East.<br> <br>  <span style="color: orange;" class="fa fa-star checked"></span>
        <span style="color: orange;"class="fa fa-star checked"></span>
        <span style="color: orange;" class="fa fa-star checked"></span>
        <span class="fa fa-star"></span>
        <span class="fa fa-star"></span><br> <br>
        <span class="current" style="font-family: 'Work Sans', sans-serif;">₹ 499.99</span>    
            <br><br>
...
<!-- -->
    ...
    <button style="border-radius: 30px; font-size: 15px;" type="button" class="fas fa-times btn cancel" onclick="closeForm()">  Close</button>
        ...
        <img style="width: 108%; " src="https://images-na.ssl-images-amazon.com/images/I/61-j2GQ1%2BDL._UL1500_.jpg" alt="" />
      </div>

...
<body>
  <div class="navbar">
    ...
    <section class="section-a">
      <div class="container">
        <div>
          <h1 style="font-family: 'Work Sans', sans-serif;">Fresh Apple Red Delicious</h1>
          <p style="font-family: 'Work Sans', sans-serif;">Ships from and sold by Cloudtail, Ghatkopar.<br> <br>  <span style="color: orange;" class="fa fa-star checked"></span>
        <span style="color: orange;"class="fa fa-star checked"></span>
        <span style="color: orange;" class="fa fa-star checked"></span>
        <span style="color: orange;" class="fa fa-star checked"></span>
        <span class="fa fa-star"></span><br> <br>
        <span class="current" style="font-family: 'Work Sans', sans-serif;">₹ 129.99 / Kg</span>    
            <br><br>
...
<!-- -->
    ...
    <button style="border-radius: 30px; font-size: 15px;" type="button" class="fas fa-times btn cancel" onclick="closeForm()">  Close</button>
        ...
        <img style="width: 115%; " src="https://images-na.ssl-images-amazon.com/images/I/81aRkv2DltL._SL1500_.jpg" alt="" />
      </div>

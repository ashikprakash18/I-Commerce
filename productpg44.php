...
<body>
  <div class="navbar">
    ...
    <section class="section-a">
      <div class="container">
        <div>
          <h1 style="font-family: 'Work Sans', sans-serif;">HP Pavilion Gaming 9th Gen Intel Core i5</h1>
          <p style="font-family: 'Work Sans', sans-serif;">Ships from and sold by HP Store, Malad west.<br> <br>  <span style="color: orange;" class="fa fa-star checked"></span>
        <span style="color: orange;"class="fa fa-star checked"></span>
        <span style="color: orange;" class="fa fa-star checked"></span>
        <span style="color: orange;" class="fa fa-star checked"></span>
        <span class="fa fa-star"></span><br> <br>
        <span class="current" style="font-family: 'Work Sans', sans-serif;">₹ 20,599.99</span>    
            <br><br>
...
<!-- -->
    ...
    <button style="border-radius: 30px; font-size: 15px;" type="button" class="fas fa-times btn cancel" onclick="closeForm()">  Close</button>
        ...
        <img style="width: 108%; " src="https://images-na.ssl-images-amazon.com/images/I/81pezrPSgOL._SL1500_.jpg" alt="" />
      </div>
